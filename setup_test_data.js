...
async function setupTestData() {
  ...
  try {
    ...
    const categories = [
      ...
      { name: 'Livres', description: 'Livres et documents' }
    ];
    ...
    const products = [
      { name: 'Smartphone Samsung', description: 'Smartphone Android', price: 150000, quantity: 10, category_id: 1 },
      { name: 'Laptop HP', description: 'Ordinateur portable', price: 450000, quantity: 5, category_id: 1 },
      { name: 'T-shirt', description: 'T-shirt en coton', price: 5000, quantity: 50, category_id: 2 },
      { name: 'Jean', description: 'Pantalon en jean', price: 15000, quantity: 30, category_id: 2 },
      { name: 'Riz', description: 'Riz parfumé', price: 2500, quantity: 100, category_id: 3 },
      { name: 'Livre JavaScript', description: 'Guide complet JavaScript', price: 12000, quantity: 20, category_id: 4 }
    ];
    ...
    const sales = [
      ...
      },
      {
        ...
        items: [
          { product_id: 4, quantity: 1, price: 15000 },
